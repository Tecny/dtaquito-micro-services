package com.dtaquito_micro_services.subscription_service.config;
...
public UserDetails loadUserByUsername(String username) throws UsernameNotFoundException {
    ...
    if (instances.isEmpty()) {
        return loadUserByUsernameFallback(username, new UsernameNotFoundException("No instances of user-service found"));
    }
    ...
    try {
        ...
        return loadUserByUsernameFallback(username, e);
    }
}

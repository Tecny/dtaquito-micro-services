...
public record CreateSportSpacesCommand(String name, Long sportId, String imageUrl, Long price, String district, String description, Long userId, String startTime, String endTime, String gamemode, Integer amount
) {

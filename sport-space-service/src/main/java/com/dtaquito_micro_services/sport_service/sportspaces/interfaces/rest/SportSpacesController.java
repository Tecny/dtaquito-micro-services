...
public class SportSpacesController {
    ...
    @CircuitBreaker(name = "default", fallbackMethod = "createSportSpacesFallback")
    public ResponseEntity<?> createSportSpaces(@RequestBody CreateSportSpacesResource resource) {
        try {
            ...
            throw new IllegalArgumentException("Failed to create sport space", e);
        }
    }
    ...
    @PutMapping("{id}")
    @CircuitBreaker(name = "default", fallbackMethod = "updateSportSpacesFallback")
    ...
    public ResponseEntity<SportSpacesResource> updateSportSpacesFallback(Long id, CreateSportSpacesResource resource, Throwable t) {
        logger.error("Fallback method for createSportSpaces", t);
        return ResponseEntity.status(HttpStatus.SERVICE_UNAVAILABLE).body(new SportSpacesResource(
                id,
                "Service Unavailable",
                null,
                "Service Unavailable",
    ...
    @GetMapping("{id}")
    @CircuitBreaker(name = "default", fallbackMethod = "getSportSpaceByIdFallback")
    ...
    @CircuitBreaker(name = "default", fallbackMethod = "getSportSpacesByUserIdFallback")

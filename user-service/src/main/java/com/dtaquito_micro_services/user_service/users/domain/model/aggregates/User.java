package com.dtaquito_micro_services.user_service.users.domain.model.aggregates;

import com.dtaquito_micro_services.user_service.iam.domain.model.commands.SignUpCommand;
import com.dtaquito_micro_services.user_service.shared.domain.model.aggregates.AuditableAbstractAggregateRoot;
...
public class User extends AuditableAbstractAggregateRoot<User> {
    ...
    @Column(nullable = false)
    private String bankAccount; // Nuevo campo
